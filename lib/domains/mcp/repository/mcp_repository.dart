import '../../settings/entity/mcp_server_config.dart';
...
abstract class McpRepository {
  /// Connects to a specific MCP server using its configuration.
  /// Handles discovery of tools provided by the server.
  Future<void> connectServer({required McpServerConfig config});
