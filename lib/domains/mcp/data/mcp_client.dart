  ...
  Future<void> connectWithTransport(ClientTransport transport) async {
    ...
    try {
      ...
      _transport!.onclose = () {
        ...
        _isConnected = false;
        localOnCloseCallback?.call(serverId);
        _transport = null;
        _tools = [];
      };
      ...
      await _fetchTools();
      _onConnectSuccess?.call(serverId, _tools);
    } catch (e) {
